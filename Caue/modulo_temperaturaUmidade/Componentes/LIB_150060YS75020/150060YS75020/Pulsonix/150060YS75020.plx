...
(library Library_1
	...
	(patternDef "150060YS75020" (originalName "150060YS75020")
		(multiLayer
			(pad (padNum 1) (padStyleRef s80) (pt -0.800, 0.000) (rotation 90))
			(pad (padNum 2) (padStyleRef s80) (pt 0.800, 0.000) (rotation 90))
		)
	...
	(symbolDef "150060YS75020" (originalName "150060YS75020")
	...
	(compDef "150060YS75020" (originalName "150060YS75020") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "150060YS75020"))
		(attachedPattern (patternNum 1) (patternName "150060YS75020")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "710-150060YS75020")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Wurth-Elektronik/150060YS75020?qs=d0WKAl%252BL4KaB8TvTwBNhow%3D%3D")
		(attr "Manufacturer_Name" "Wurth Elektronik")
		(attr "Manufacturer_Part_Number" "150060YS75020")
		(attr "Description" "WURTH ELEKTRONIK - 150060YS75020 - LED, Yellow, SMD, 0603 [1608 Metric], 20 mA, 2 V, 590 nm")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/150060YS75020.pdf")
		(attr "<Component Height>" "0.45")
		(attr "<STEP Filename>" "150060YS75020.stp")
