...
(library Library_1
	...
	(compDef "ST25DV04K-IER6S3" (originalName "ST25DV04K-IER6S3") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "V_EH") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "AC0") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "AC1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "GPO(OD)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://ms.componentsearchengine.com/Datasheets/2/ST25DV04K-IER6S3.pdf")
		(attr "Height" "1.75 mm")
	)
