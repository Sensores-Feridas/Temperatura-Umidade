...
//1264915/1525947/2.50/3/3/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "SQ2364EES-T1_GE3" (originalName "SQ2364EES-T1_GE3")
	...
	(compDef "SQ2364EES-T1_GE3" (originalName "SQ2364EES-T1_GE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SQ2364EES-T1_GE3"))
		...
		(attr "Mouser Part Number" "78-SQ2364EES-T1_GE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Semiconductors/SQ2364EES-T1_GE3?qs=lYGu3FyN48cd%2FdtaQTPJxw%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SQ2364EES-T1_GE3")
		(attr "Description" "Automotive N-Channel 60 V (D-S)175C  MOS")
		(attr "<Hyperlink>" "http://www.vishay.com/ppg?75975&quality")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SQ2364EES-T1_GE3.stp")
