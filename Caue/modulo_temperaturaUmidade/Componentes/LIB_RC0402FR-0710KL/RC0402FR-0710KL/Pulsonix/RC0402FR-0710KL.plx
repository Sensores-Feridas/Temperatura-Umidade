...
//16154738/1525947/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-0710KL" (originalName "RC0402FR-0710KL")
	...
	(compDef "RC0402FR-0710KL" (originalName "RC0402FR-0710KL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-0710KL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-0710KL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0402FR-0710KL?qs=I1mnnYJTTsxUoNwrUsQExA%3D%3D")
		(attr "Manufacturer_Name" "YAGEO")
		(attr "Manufacturer_Part_Number" "RC0402FR-0710KL")
		(attr "Description" "Yageo 10k, 0402 (1005M) Thick Film SMD Resistor +/-1% 0.063W - RC0402FR-0710KL")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/RC0402FR-0710KL.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-0710KL.stp")
