...
//544029/1525947/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS71733DCKR" (originalName "TPS71733DCKR")
	...
	(compDef "TPS71733DCKR" (originalName "TPS71733DCKR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "NR/FB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS71733DCKR"))
		...
		(attr "Mouser Part Number" "595-TPS71733DCKR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS71733DCKR?qs=QZuYiDxzHaicbGKtUrLzCQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS71733DCKR")
		(attr "Description" "150mA, High PSRR, Low Quiescent Current, Low Noise LDO")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tps717")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TPS71733DCKR.stp")
