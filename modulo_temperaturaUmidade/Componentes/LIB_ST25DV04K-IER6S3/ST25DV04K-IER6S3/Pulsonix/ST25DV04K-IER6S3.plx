...
//766055/1525947/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ST25DV04K-IER6S3" (originalName "ST25DV04K-IER6S3")
	...
	(compDef "ST25DV04K-IER6S3" (originalName "ST25DV04K-IER6S3") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "V_EH") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "AC0") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "AC1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "GPO(OD)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ST25DV04K-IER6S3"))
		...
		(attr "Mouser Part Number" "511-ST25DV04K-IER6S3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/ST25DV04K-IER6S3?qs=xjeEZJU9OeNdtP1j9447OQ%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "ST25DV04K-IER6S3")
		(attr "Description" "STMICROELECTRONICS - ST25DV04K-IER6S3 - RFID/NFC IC, 13.553 MHz to 13.567 MHz, Read, Write, 4Kbit, I2C, 1.8 V to 5.5 V, SOIC-8")
		(attr "<Hyperlink>" "https://ms.componentsearchengine.com/Datasheets/2/ST25DV04K-IER6S3.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ST25DV04K-IER6S3.stp")
